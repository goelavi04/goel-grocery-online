...
const Auth: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: isLogin ? "You've successfully logged in" : "You can now start shopping"
    });
    navigate('/');
  };
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 input-grocery h-12"
                  />
                </div>
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  placeholder="••••••••"
                  className="pl-10 pr-10 input-grocery h-12"
                />
                <button
                  type="button"
            ...
            <Button type="submit" className="w-full btn-primary h-12 text-base gap-2" size="lg">
